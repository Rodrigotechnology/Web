...
const tutorials = {
  gpt3: [
    ...
    {url: "https://valvepress.com/how-to-increase-the-number-of-posts-for-every-added-keyword-to-wordpress-automatic-campaign/", title: "How to increase the number of posts for every added keyword to WordPress Automatic campaign"},
  ],
  Articles: [],
  Feeds: [
    {
